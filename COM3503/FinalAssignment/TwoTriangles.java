...
public class TwoTriangles extends Mesh {
  ...
  //several modes are added to make different property
  ...
  //using different shader when setting different mode
  //window mode enable transparent effect
  public void window(GL3 gl, Vec4 winTexPos){
    shader = new Shader(gl, "vs_tt_05.txt", "fs_wd_05.txt");
    windowMode = true;
    window_position = winTexPos;
  }
  
  //scenaryMode enable the mesh not being affected by the room light
