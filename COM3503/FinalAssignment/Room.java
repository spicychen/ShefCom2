...
public class Room {
	...
	public void initialise(GL3 gl,  Light[] lights, Camera camera){
		...
		int[] picture1_texture = TextureLibrary.loadTexture(gl, "textures/Hand1.jpg");
		int[] picture2_texture = TextureLibrary.loadTexture(gl, "textures/Hand2.jpg");
		int[] picture3_texture = TextureLibrary.loadTexture(gl, "textures/Hand3.jpg");
		int[] picture4_texture = TextureLibrary.loadTexture(gl, "textures/Hand4.jpg");
		int[] picture5_texture = TextureLibrary.loadTexture(gl, "textures/Hand5.jpg");
