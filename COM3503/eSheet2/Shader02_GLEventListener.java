...
public class Shader02_GLEventListener implements GLEventListener {
  
  private static final boolean DISPLAY_SHADERS = false;
    
  /* The constructor is not used to initialise anything */
  public Shader02_GLEventListener() {
  }
  ...
  public void render(GL3 gl) {
    ...
    float blueValue = (float)Math.sin(elapsedTime*5);
    ...
    float x_pos = (float)Math.sin(elapsedTime*5);
    float y_pos = (float)Math.cos(elapsedTime*5);
    float z_pos = 0.0f;
    int vertexPositionLocation = gl.glGetUniformLocation(shaderProgram, "ourPosition");
    gl.glUniform3f(vertexPositionLocation, x_pos, y_pos, z_pos);
