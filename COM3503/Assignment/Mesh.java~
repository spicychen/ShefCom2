...
public abstract class Mesh {
  ...
  protected Mat4 fakeModel;
  protected Mat4 originalModel;
  
  protected Mesh child_mesh;
//  protected Vector<transformationSequence> trans;
    
  public Mesh(GL3 gl) {
    material = new Material();
    model = new Mat4(1);
    fakeModel = new Mat4(1);
//    trans = new Vector<transformationSequence>();
  }
  
  public void setModelMatrix() {
    model = new Mat4(1);
    fakeModel = new Mat4(1);
    originalModel = new Mat4(1);
  }
