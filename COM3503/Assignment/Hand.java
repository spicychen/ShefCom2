...
public class Hand{
	...
	private float thumb_length = 2.5f;
	private float index_length = 2.5f;
	private float middle_length = 3.0f;
	private float fingers_distance = 1.0f;
	private float SCALE = 0.2f;
	
	private Vec3 thumb_Scale = new Vec3(thumb_length*SCALE,1.0f*SCALE,1.0f*SCALE);
	private Vec3 thumb_offset = new Vec3(0.5f,0.0f,0.0f);
	private Vec3 thumb_position = new Vec3(half(palm_size)*SCALE,0.0f,0.0f);
	
	private Vec3 index_Scale = new Vec3(1.0f*SCALE,index_length*SCALE,1.0f*SCALE);
	...
	private float[][] index2_animation = {{0.0f, 0.0f, 0.0f},
									{6.0f, 0.0f, 0.0f},
									{12.0f, 0.0f, 0.0f},
									{18.0f, 0.0f, 0.0f},
									{24.0f, 0.0f, 0.0f},
	...
	private float[][] index3_animation = {{0.0f, 0.0f, 0.0f},
									{4.0f, 0.0f, 0.0f},
									{8.0f, 0.0f, 0.0f},
									{12.0f, 0.0f, 0.0f},
									{16.0f, 0.0f, 0.0f},
	...
	private void initialise(){
		...
		parts[0].translateModel(new Vec3(2.6f*SCALE,0.0f,0.0f));
		parts[1].initialScale(thumb_Scale, thumb_offset);
		parts[1].translateModel(new Vec3(2.6f*SCALE,0.0f,0.0f));
		...
		parts[3].translateModel(new Vec3(0.0f,2.6f*SCALE,0.0f));
		parts[4].initialScale(index_Scale, index_offset);
		parts[4].translateModel(new Vec3(0.0f,2.6f*SCALE,0.0f));
	...
	private void rotateFingers(){
		...
		parts[2].fullRotate(0.0f,0.0f,30.0f);
	}
	...
	public void animateFingers(int time){
		...
		for(Cube p: parts)
			p.retrieve();
		parts[6].fakeFullRotate(index2_animation[time]);
		parts[7].fakeFullRotate(index2_animation[time]);
		parts[8].fakeFullRotate(index2_animation[time]);
		parts[9].fakeFullRotate(index2_animation[time]);
		parts[10].fakeFullRotate(index2_animation[time]);
		parts[11].fakeFullRotate(index2_animation[time]);
		parts[12].fakeFullRotate(index2_animation[time]);
		parts[13].fakeFullRotate(index2_animation[time]);
		parts[14].fakeFullRotate(index2_animation[time]);
