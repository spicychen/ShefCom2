...
public class Texture03_GLEventListener implements GLEventListener {
  
  private static final boolean DISPLAY_SHADERS = false;
  private Shader shader;
    
  /* The constructor is not used to initialise anything */
  public Texture03_GLEventListener() {
  }
  ...
  public void render(GL3 gl) {
    ...
    float maomi = (float)Math.sin(elapsedTime*5);
  
    shader.setFloat(gl, "maomi", maomi, 0.0f);
