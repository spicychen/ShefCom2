...
public class Texture04_GLEventListener implements GLEventListener {
  
  private static final boolean DISPLAY_SHADERS = false;
  private Shader shader;
    
  /* The constructor is not used to initialise anything */
  public Texture04_GLEventListener() {
  }
  ...
  public void initialise(GL3 gl) {
    shader = new Shader(gl, "t04_vs.txt", "t04_fs.txt");
    fillBuffers(gl);
  ...
  public void render(GL3 gl) {
    ...
    double t = elapsedTime*0.5;  // *0.1 slows it down a bit
