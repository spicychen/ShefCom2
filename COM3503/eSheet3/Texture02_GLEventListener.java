...
public class Texture02_GLEventListener implements GLEventListener {
  
  private static final boolean DISPLAY_SHADERS = false;
  private Shader shader;
    
  /* The constructor is not used to initialise anything */
  public Texture02_GLEventListener() {
  }
  ...
  public void render(GL3 gl) {
    ...
    float maomii = (float)Math.sin(elapsedTime*5);
    
    shader.setFloat(gl, "maomi", maomii, 0.0f);
