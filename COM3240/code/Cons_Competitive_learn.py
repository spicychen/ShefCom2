...
np.savetxt('conscience_weight_change.csv',average_dw,delimiter=",")
np.savetxt('conscience_weight.csv',W,delimiter=',')
np.savetxt('conscience_counter.csv',counter,delimiter=',')