...
public class Castle {
	...
	public static void main(String[] args) {
		...
		System.out.println("The Castle "+myCastle.getName()+
				" is "+myCastle.isDoorLocked()+" LockedDoor and is "+
				myCastle.isFlagRaised()+" RaisedFlag and is "+
				myCastle.getGuard()+" getGuard");
