...
public class RedGiant extends Star {
	...
	public boolean equals(Object obj){
		if(obj == null)
			...
			return false;
		else if(this.getMagnitude() == ((RedGiant)obj).getMagnitude()
				&& this.getSurfaceTemperature() == ((RedGiant)obj).getSurfaceTemperature()
				&& this.getYearsToExtinction() == ((RedGiant)obj).getYearsToExtinction())
			return true;
		else
			return false;
	}
