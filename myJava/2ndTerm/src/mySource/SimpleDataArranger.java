...
public class SimpleDataArranger {
	...
	class Data{
		...
		public boolean convert(){//convert the data in file to useful system-understandable info
			...
			avg = total/j;
			} catch(NumberFormatException e) { //deal with the error data
				System.out.println("some error is in the data");
				convertable=false;
			}
				diff = max-min;
				return convertable;
